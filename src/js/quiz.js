document.addEventListener('DOMContentLoaded', ()=>{
    ...
    function mostrarResultado(){
        ...
        // CRIANDO UMA VARIÁVEL QUE CRIA UMA LISTA, VAI PEGAR AS QUESTÕES
        // LA DE CIMA E PERGUNTANDO CADA UMA E A RESPECTIVA RESPOSTA PARA A LISTA
    ...
    proximaPergunta.addEventListener('click',nextPergunta);
